           		...
           		<form method="post" action="./reportAction.jsp">
	                <div class="board_write">
	                    <div class="title">
	                        <dl>
	                            <dt>제목</dt>
	                            <dd><input type="text" class="form-control" placeholder="신고 제목" name="reportTitle" maxlength="50"></dd>
	                        </dl>
	                    </div>
	                    <div class="info">
	                    ...
	                    <div class="cont">
	                        <textarea class="form-control" placeholder="신고 내용" name="reportContent" maxlength="2048" style="height: 350px;"></textarea>
	                    </div>
	                </div>
	                <div class="bt_wrap">
	                    <input type="submit" class="btn btn-primary pull-right" style="bottom: -55px;" value="신고하기">	
